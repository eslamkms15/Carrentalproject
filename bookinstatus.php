...
?>
   <ul><li> <button  class="utton"><a href="cardetails.php">الرئيسية</a></button></li><li class="name">اهلا بك! <?php echo $rows2['FNAME']." ".$rows2['LNAME']?></li>
    ...
    <div class="box">
         <div class="content">
             <h1>أسم السيارة : <?php echo $rows3['CAR_NAME']?></h1><br>
             <h1>عدد الايام : <?php echo $rows['DURATION']?></h1><br>
             <h1>حالة الحجز : <?php echo $rows['BOOK_STATUS']?></h1><br>
