...
<?php 
  ...
  <div class="cd">
        ...
        <div class="navbar">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><a href="feedback/Feedbacks.php">التقيمات</a></li>
                    ...
                    <li><a id="stat" href="bookinstatus.php">حالة الحجز</a></li>
                </ul>
            </div>
            
            
        </div>
      <div><h1 class="overview">نظرة عامة على سياراتنا</h1>
    ...
    <li>
    <form action ="booking.php?id=<?php echo $res;?>" method="POST">
    <div class="box">
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>نوع الوقود : <a><?php echo $result['FUEL_TYPE']?></a> </h2>
            <h2>السعة : <a><?php echo $result['CAPACITY']?></a> </h2>
            <h2>الايجار في اليوم : <a>ريال<?php echo $result['PRICE']?></a></h2>
            <button type="submit"  name="booknow" class="utton" style="margin-top: 5px;"><a >حجز</a></button>
        </div>
    </div></form></li>
    <?php
        }
