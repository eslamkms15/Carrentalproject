...
<?php 
    ...
    if(isset($_POST['book'])){
        ...
        if(empty($bplace)|| empty($bdate)|| empty($dur)|| empty($phno)|| empty($des)|| empty($rdate)){
            ...
            echo  '<script>alert("برجاء ادخال تاريخ ارجاع صحيح")</script>';
        }
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            <h2>اسم السيارة : <?php echo "".$email['CAR_NAME']?></h2>
            <label>مكان الحجز : </label>
            <br>
            <input type="text" name="place"
            id="name" placeholder="ادخل مكان الحجز">
            <br><br>

            <label>تاريخ الحجز : </label>
            <br>
            <input type ="date" name="date"
            id="datefield" min='1899-01-01' max='2000-13-13'  placeholder="ادخل تاريخ الحجز">
            <br><br>

            <label>المدة : </label>
            <br>
            <input type ="number" name="dur" min="1" max="30" 
            id="name" placeholder="ادخل المدة  (بالايام)">
            <br><br>

            <label>رقم الهاتف : </label>
            <br>
            <input type="tel" name="ph" maxlength="10"
            id="name" placeholder="ادخل رقم الهاتف">
            <br><br>
            
            <label>متجه الي : </label>
            <br>
            <input type="text" name="des"
            id="name" placeholder="ادخل اتجاهك">
            <br><br>

            <label>تاريخ الارجاع : </label>
            <br>
            <input type ="date" name="rdate"
            id="dfield"  min='1899-01-01' placeholder="ادخل تاريخ الارجاع">
            <br><br>
            <input type="submit"  class="btnn" value="حجز" name="book" >
